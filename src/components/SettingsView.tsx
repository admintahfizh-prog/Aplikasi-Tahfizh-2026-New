    ...
    <div className="space-y-6 animate-in fade-in max-w-5xl pb-16">
      ...
      {activeTab === 'database' && (
        <div className="space-y-5">
              ...
              <div className="space-y-1.5">
                {storageService.isQuotaExceeded() ? (
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/20 text-amber-300 text-[11px] font-bold border border-amber-500/30">
                    ...
                    Batas Kuota Harian Tercapai (Mode Penyimpanan Lokal Aktif)
                  </div>
                ) : (
          ...
          {/* QUOTA WARNING ALERT BOX (IF QUOTA EXCEEDED) */}
          {storageService.isQuotaExceeded() && (
            <div className="p-5 bg-amber-50 border border-amber-300 rounded-2xl text-slate-800 shadow-xs space-y-3">
              <div className="flex items-start gap-3.5">
                <div className="w-10 h-10 rounded-xl bg-amber-100 border border-amber-200 flex items-center justify-center shrink-0 text-amber-800 shadow-xs">
                ...
                <div className="space-y-1.5 flex-1">
                  ...
                  <p className="text-xs sm:text-sm text-slate-700 leading-relaxed">
                    Batas kuota pembacaan harian Firebase Firestore (Spark Free Tier: 50.000 read units per hari) telah tercapai untuk proyek ini.
                    Seluruh fungsionalitas aplikasi (pencatatan setoran hafalan, mutasi nilai Ummi, pengelolaan santri, dan cetak rapor) <strong>tetap berfungsi normal menggunakan penyimpanan lokal (offline cache) di perangkat Anda</strong>. Kuota gratis harian akan di-reset otomatis besok hari oleh Firebase.
                  </p>
                  <div className="pt-2 flex flex-wrap items-center gap-2.5">
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-amber-600 hover:bg-amber-700 text-white font-semibold text-xs shadow-xs transition"
                    >
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-white hover:bg-slate-100 text-slate-800 font-semibold text-xs border border-slate-300 transition cursor-pointer"
                    >
                      <RefreshCw className="w-3.5 h-3.5 text-slate-600" />
                      <span>Reset & Coba Sambungkan Ulang</span>
                    </button>
                  </div>
                </div>
              </div>
